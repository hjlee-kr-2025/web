...
-- Table `gyshop`.`image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gyshop`.`image` ;

CREATE TABLE IF NOT EXISTS `gyshop`.`image` (
  `no` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  `hit` BIGINT NULL DEFAULT 0,
  PRIMARY KEY (`no`),
  INDEX `fk_image_member1_idx` (`id` ASC) VISIBLE,
...
-- Table `gyshop`.`goods`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gyshop`.`goods` ;

CREATE TABLE IF NOT EXISTS `gyshop`.`goods` (
  `no` BIGINT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(400) NOT NULL,
  `content` VARCHAR(4000) NOT NULL,
  `photo` VARCHAR(200) NOT NULL,
  `subPhoto1` VARCHAR(200) NULL,
  `subPhoto2` VARCHAR(200) NULL,
  `subPhoto3` VARCHAR(200) NULL,
  `subPhoto4` VARCHAR(200) NULL,
  `price` INT NOT NULL,
...
-- Table `gyshop`.`cart`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gyshop`.`cart` ;

CREATE TABLE IF NOT EXISTS `gyshop`.`cart` (
  `no` BIGINT NOT NULL AUTO_INCREMENT,
  `id` VARCHAR(20) NOT NULL,
  `gno` BIGINT NOT NULL,
  `count` INT NOT NULL,
...
-- Table `gyshop`.`movie`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gyshop`.`movie` ;

CREATE TABLE IF NOT EXISTS `gyshop`.`movie` (
  `no` BIGINT NOT NULL AUTO_INCREMENT,
  `movieCd` VARCHAR(20) NOT NULL,
  `movieNm` VARCHAR(400) NULL,
  `movieNmEn` VARCHAR(200) NULL,
  `openDt` VARCHAR(20) NULL,
  `typeNm` VARCHAR(100) NULL,
  `prdtStatNm` VARCHAR(40) NULL,
  `repNationNm` VARCHAR(80) NULL,
  `repGenreNm` VARCHAR(80) NULL,
  `peopleNm` VARCHAR(80) NULL,
  PRIMARY KEY (`no`),
  UNIQUE INDEX `movieCd_UNIQUE` (`movieCd` ASC) VISIBLE)
ENGINE = InnoDB;
