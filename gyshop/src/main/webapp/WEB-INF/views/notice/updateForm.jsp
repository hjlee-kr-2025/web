...
<div class="container topbox">
	<h2><i class="fa fa-edit"></i> 공지사항 글수정</h2>
	<form action="update.do" method="post"
		...
		<!-- 서버로 파일이 전송될때는 아래 2가지는 form태그에 적용되어야 합니다.
		 ...
		 -->
		<!-- type="hidden" 속성을 사용하는 이유는 화면에 보일 필요는 없지만
				데이터베이스 또는 서버에서 사용할 필요가 있는 데이터를 보낼때 사용합니다.
				여기서는 기존이미지를 지울때 사용할 경로를 담아서 보냈습니다.
		 -->
	  ...
	  <div class="form-group">
	  	...
	  	<textarea class="form-control" id="content"
	  		name="content" rows="10">${vo.content }</textarea>
	  </div>
	  <div class="form-group">
